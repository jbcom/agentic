...
let _githubClient = null;
let _clientPromise = null;
let _graphqlClient = null;
let _graphqlPromise = null;
/**
 ...
 */
export async function closeGitHubClient() {
    if (_githubClient) {
 ...
 */
export async function getGraphQLMCPClient() {
    if (_graphqlClient)
 ...
 */
export async function closeGraphQLClient() {
    if (_graphqlClient) {
...
export function getRepoContext() {
    ...
    throw new Error('Could not determine repository context. Set GITHUB_REPOSITORY or ensure git remote is configured.');
}
// Re-export for compatibility
export function getOctokit() {
    throw new Error('Octokit is deprecated. Use GitHub MCP functions instead:\n' +
 ...
 */
export async function getIssue(issueNumber, repoContext) {
 ...
 */
export async function createIssue(issue, repoContext) {
    const { owner, repo } = repoContext || getRepoContext();
 ...
 */
export async function updateIssue(issueNumber, updates, repoContext) {
    const { owner, repo } = repoContext || getRepoContext();
 ...
 */
export async function searchIssues(query, repoContext) {
 ...
 */
export async function searchIssuesGraphQL(query, options = {}, repoContext) {
    const { owner, repo } = repoContext || getRepoContext();
 ...
 */
export async function listCommits(branch, options = {}) {
    const { owner, repo } = getRepoContext();
 ...
 */
export async function getFileContents(path, options = {}) {
    const { owner, repo } = getRepoContext();
 ...
 */
export async function convertPRToDraft(prNumber) {
 ...
 */
export async function enableAutoMerge(prNumber, mergeMethod = 'SQUASH') {
    const pullRequestId = await getPRNodeId(prNumber);
    const mutation = `
 ...
 */
export async function disableAutoMerge(prNumber) {
    const pullRequestId = await getPRNodeId(prNumber);
    const mutation = `
 ...
 */
export async function replyToReviewComment(prNumber, commentNodeId, body) {
    const pullRequestId = await getPRNodeId(prNumber);
    const mutation = `
 ...
 */
export async function areAllChecksPassing(ref) {
 ...
 */
export async function waitForChecks(ref, options) {
...
export function formatAlertsForAI(codeScanning, dependabot) {
    const lines = [];
 ...
 */
export async function getPRReviewThreads(prNumber) {
    const { owner, repo } = getRepoContext();
    const query = `
 ...
 */
export async function markPRReadyForReview(prNumber) {
    const pullRequestId = await getPRNodeId(prNumber);
    const mutation = `
