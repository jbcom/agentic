...
export async function resolveModel(config = {}) {
    ...
    throw new Error(`Provider ${providerName} is not supported in this version. Only 'ollama' provider is currently supported. ` +
 ...
 */
export async function generateWithTools(prompt, tools, options = {}) {
    const resolved = await resolveModel(options);
