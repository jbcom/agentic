 ...
 */
export function getIssueTools(customConnectors) {
    ...
    return {
        ...
        get_issue_stats: tool({
            description: 'Get statistics about issues - counts by status, priority, and type. ' +
 ...
 */
export function getProjectTools(customConnectors) {
    const connectors = getConnectors(customConnectors);
    return {
 ...
 */
export function getReviewTools(customConnectors) {
    const connectors = getConnectors(customConnectors);
    return {
 ...
 */
export function getTriageTools(customConnectors) {
    return {
