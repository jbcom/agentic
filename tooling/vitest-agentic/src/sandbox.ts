/**
 * Sandbox execution mocking utilities for @jbcom/agentic testing.
 *
 ...
 * @example
 * ```typescript
 * import { SandboxMocker } from '@jbcom/vitest-agentic';
 *
...
export class SandboxMocker {
  ...
  /**
   * Mock the ContainerManager class from @jbcom/agentic.
   */
  mockContainerManager(): Mock {
    ...
    vi.doMock('@jbcom/agentic/sandbox', () => ({
      ContainerManager: mockManager,
    }));

    this.mockedModules.add('@jbcom/agentic/sandbox');
    return mockManager;
  }

  /**
   * Mock the SandboxExecutor class from @jbcom/agentic.
   */
