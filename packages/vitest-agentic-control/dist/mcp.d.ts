 ...
 */
declare const MCP_MODULES: readonly ["@modelcontextprotocol/sdk", "@modelcontextprotocol/sdk/client", "@modelcontextprotocol/sdk/server", "@ai-sdk/mcp"];
/**
 ...
 */
interface MockResourceDefinition {
    /** Resource URI */
    uri: string;
    /** Resource name */
    name?: string;
 ...
 */
declare function createMcpMocker(options?: McpMockerOptions): McpMocker;

export { MCP_MODULES, McpMocker, type McpMockerOptions, type MockMcpResource, MockMcpServer, type MockMcpServerConfig, type MockMcpTool, type MockResourceDefinition, type MockToolDefinition, createMcpMocker };
