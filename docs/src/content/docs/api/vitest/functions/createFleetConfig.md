...
Defined in: [fixtures.ts:176](https://github.com/jbcom/agentic/blob/3e0fc0dae3f16f8cce14665d77f819f138b021fa/tooling/vitest-agentic/src/fixtures.ts#L176)
...
```typescript
import { createFleetConfig } from '/vitest-agentic';
