...
Defined in: [fixtures.ts:143](https://github.com/jbcom/agentic/blob/3e0fc0dae3f16f8cce14665d77f819f138b021fa/tooling/vitest-agentic/src/fixtures.ts#L143)
...
```typescript
import { createTokenConfig } from '/vitest-agentic';
