/**
 * Core mocking utilities for @jbcom/agentic testing.
 *
...
/**
 * Main mocker class for comprehensive @jbcom/agentic testing.
 *
 * This class provides a unified interface for mocking all @jbcom/agentic
 * components: MCP servers, AI providers, sandbox execution, and more.
 *
 * @example Basic usage
 * ```typescript
 * import { AgenticMocker } from '@jbcom/vitest-agentic';
 *
...
export class AgenticMocker {
  ...
  /**
   * Mock all @jbcom/agentic framework modules.
   *
   * This mocks the common modules used in @jbcom/agentic:
   * - MCP SDK modules
   * - AI SDK modules
 ...
 * @example
 * ```typescript
 * import { createAgenticMocker } from '@jbcom/vitest-agentic';
 *
