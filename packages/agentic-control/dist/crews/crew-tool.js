...
export class CrewTool {
    ...
    async invokeCrew(options) {
        ...
        try {
            ...
            const result = await this.executeCommand(['run', validated.package, validated.crew, '--input', validated.input, '--json'], {
        ...
        return new Promise((resolve) => {
            ...
            proc.on('error', (error) => {
                ...
                if (error.code === 'ENOENT') {
                    ...
                    resolve({
                        success: false,
                        error: `${executableName} not found. Install with: ${this.config.invokeMethod === 'uv'
...
//# sourceMappingURL=crew-tool.js.map