 ...
 */
interface SandboxMockerOptions {
 ...
 */
declare function createSandboxMocker(options?: SandboxMockerOptions): SandboxMocker;

export { type MockContainer, type MockContainerConfig, type MockExecutionResult, SandboxMocker, type SandboxMockerOptions, createSandboxMocker };
