 ...
 */
export declare function normalizePriority(value: number | string): IssuePriority;
/**
 * Map normalized priority to numeric value (0 is highest)
 */
export declare function priorityToNumber(priority: IssuePriority): number;
/**
 * Map provider status strings to normalized status
 */
export declare function normalizeStatus(value: string): IssueStatus;
/**
 * Map provider type strings to normalized type
 */
export declare function normalizeType(value: string): IssueType;
