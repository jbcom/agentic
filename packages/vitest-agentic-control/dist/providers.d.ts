 ...
 */
declare const SUPPORTED_PROVIDERS: readonly ["anthropic", "openai", "google", "mistral", "azure", "ollama"];
type SupportedProvider = (typeof SUPPORTED_PROVIDERS)[number];
/**
 * Provider module paths for mocking.
 */
declare const PROVIDER_MODULES: Record<SupportedProvider, string>;
/**
 * Common AI SDK modules.
 */
declare const AI_SDK_MODULES: readonly ["ai", "ai/rsc"];
/**
 ...
 */
interface ProviderMockerOptions {
 ...
 */
declare function createProviderMocker(options?: ProviderMockerOptions): ProviderMocker;

export { AI_SDK_MODULES, type MockProviderResponse, type MockStreamChunk, PROVIDER_MODULES, ProviderMocker, type ProviderMockerOptions, SUPPORTED_PROVIDERS, type SupportedProvider, createProviderMocker };
