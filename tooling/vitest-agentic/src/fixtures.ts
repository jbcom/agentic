/**
 * Test fixtures for @jbcom/agentic testing.
 *
 * This module provides pre-configured test fixtures for common
 * @jbcom/agentic configurations, making it easy to set up tests.
 *
 * @module fixtures
 */
 ...
 * @example
 * ```typescript
 * import { createTestConfig } from '@jbcom/vitest-agentic';
 *
 ...
 * @example
 * ```typescript
 * import { createTokenConfig } from '@jbcom/vitest-agentic';
 *
 ...
 * @example
 * ```typescript
 * import { createFleetConfig } from '@jbcom/vitest-agentic';
 *
 ...
 * @example
 * ```typescript
 * import { createTriageConfig } from '@jbcom/vitest-agentic';
 *
 ...
 * @example
 * ```typescript
 * import { createSandboxConfig } from '@jbcom/vitest-agentic';
 *
 ...
 * @example
 * ```typescript
 * import { withTestEnv, DEFAULT_TEST_ENV } from '@jbcom/vitest-agentic';
