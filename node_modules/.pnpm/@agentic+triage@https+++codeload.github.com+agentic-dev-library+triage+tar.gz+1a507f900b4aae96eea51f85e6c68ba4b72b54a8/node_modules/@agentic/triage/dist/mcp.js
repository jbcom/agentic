 ...
 */
export async function createFilesystemClient(workingDirectory) {
 ...
 */
export async function createInlineFilesystemClient(workingDirectory) {
 ...
 */
export async function getFilesystemTools(client) {
    return client.tools();
}
// =============================================================================
// GITHUB MCP
 ...
 */
export async function getGitHubTools(client) {
    return client.tools();
}
// =============================================================================
// PLAYWRIGHT MCP
 ...
 */
export async function getPlaywrightTools(client) {
    return client.tools();
}
// =============================================================================
 ...
 */
export async function getContext7Tools(client) {
    return client.tools();
}
// =============================================================================
 ...
 */
export async function getViteReactTools(client) {
    return client.tools();
}
// =============================================================================
// GRAPHQL MCP
 ...
 */
export async function getGraphQLTools(client) {
    return client.tools();
}
/**
...
export async function initializeMCPClients(options) {
    ...
    if (options.filesystem) {
        ...
        initPromises.push(createFilesystemClient(dir)
            .then((client) => {
    ...
    if (options.github) {
        initPromises.push(createGitHubClient()
            .then((client) => {
    ...
    if (options.playwright) {
        ...
        initPromises.push(createPlaywrightClient(playwrightOpts)
            .then((client) => {
    ...
    if (options.context7) {
        initPromises.push(createContext7Client()
            .then((client) => {
    ...
    if (options.viteReact) {
        ...
        initPromises.push(createViteReactClient(viteOpts)
            .then((client) => {
    ...
    if (options.graphql) {
        initPromises.push(createGraphQLClient()
            .then((client) => {
...
export async function runAgenticTask(options) {
    const { systemPrompt, userPrompt, mcpClients: clientOptions = { filesystem: true }, maxSteps = 15, onToolCall, onStepFinish, } = options;
