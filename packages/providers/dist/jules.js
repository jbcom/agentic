 ...
 */
export function createJulesAgent(id, config, options = {}) {
 ...
 */
export async function pollJulesSession(config, sessionName) {
    const baseUrl = config.baseUrl ?? DEFAULT_BASE_URL;
 ...
 */
export async function sendJulesFollowUp(config, sessionName, message) {
    const baseUrl = config.baseUrl ?? DEFAULT_BASE_URL;
